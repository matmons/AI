...
#List Comprehension to conver L to our format 
# that as been swaped out in every occurrences of L for all functions
# enabling them all to work with the standard L
myL = [[list(i[0])[0]+' '+list(i[0])[1]]+i[1:] for i in L]
