    ...
    def __init__(self, fh):
        ...
        for line in lines:
            ...
            if line[0] == 'C':
                ...
                self.connections = [(self.room_names.index(c1), self.room_names.index(c2)) for c1, c2 in
                                    self.connections]
    ...
    def gen_net(self):
        ...
        for t in range(1, self.T):
            for r in range(self.N):
                ...
                combs = itertools.combinations_with_replacement([True, False], len(self.rooms[r].conns_idx))
                perms = [item for comb in combs for item in itertools.permutations(comb)]
